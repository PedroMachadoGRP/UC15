...
import { MulBottonProps } from '../interfaces/NavigationInterfaces';
import { SafeAreaProvider, SafeAreaView } from 'react-native-safe-area-context';



export default function Mult({ navigation }: MulBottonProps) {
    const [num1, setNum1] = useState("");
    const [num2, setNum2] = useState("");
    const [multi, setmult] = useState<number>(0)
        ...
        <SafeAreaProvider>
            <SafeAreaView>
                <View style={styles.container}>
                    ...
                    <Button title='Multiplicar' onPress={() => { mult() }}></Button>
                    <Text style={styles.result}> Resultado da Multiplicação = {multi}</Text>
                </View>
            </SafeAreaView>
        </SafeAreaProvider>
