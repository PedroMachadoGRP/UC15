...
import { SubBottonProps,} from '../interfaces/NavigationInterfaces';
import { SafeAreaProvider, SafeAreaView } from 'react-native-safe-area-context';



export default function Sub({ navigation }: SubBottonProps) {
        ...
        <SafeAreaProvider>
            <SafeAreaView>
                <View style={styles.container}>
                    ...
                    <Button title='Subtrair' onPress={() => {sub()}}></Button>
                    <Text style={styles.result}> Resultado da Subtração = {Sub}</Text>
                </View>
            </SafeAreaView>
        </SafeAreaProvider>
